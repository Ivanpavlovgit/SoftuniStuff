...
public class ComputerManagerTests {
    ...
    public void setUp () {
        ...
        computer = new Computer ("DELL","A1234",300.00);
        computer2 = new Computer ("ASUS","ROG",400.00);
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testGet () {
        this.computerManager.getComputer (null,"test model");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGet2 () {
        this.computerManager.getComputer ("manufacturer test",null);
    }
