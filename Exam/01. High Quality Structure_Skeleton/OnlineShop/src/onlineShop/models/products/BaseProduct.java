...
public abstract class BaseProduct implements Product {
    ...
    public String toString () {
        ...
        return String.format (PRODUCT_TO_STRING,this.getOverallPerformance (),this.getPrice (),this.getClass ().getSimpleName (),this.getManufacturer (),this.getModel (),this.getId ());
    }
}
